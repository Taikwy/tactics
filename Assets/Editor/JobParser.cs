...
public static class JobParser 
{
    ...
    static void ParseStartingStats (){
        string readPath = string.Format("{0}/Data/JobStartingStats.csv", Application.dataPath);
    ...
    static void PartsStartingStats (string line){
        ...
        StatModifierFeature move = GetFeature (obj, StatTypes.MV);
        move.amount = Convert.ToInt32(elements[5]);
